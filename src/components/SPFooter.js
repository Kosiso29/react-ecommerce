...
const SPFooter = () => {
    return (
        <footer className='fotBg'>
            <div className="flex flex-wrap justify-between gap-x-32 gap-y-16 py-10 fof fotBg text-xl text-base-content wrapper">
            ...
            <div className="footer py-4 border-t fotBg text-base-content border-base-300 wrapper">
                <div className="items-center grid-flow-col">
                    ...
                    <p className='font-bold'>BUILT BY BWAILI Co. <br /></p>
                </div>
